...
|---|---|---|---|
| `acme` | This is ACME, release 0.97 ("Zem"), 28 June 2020 | 1 | 423 |
| `asl` | Macro Assembler 1.42 Beta [Bld 309] | 14 | 2318 |
| `ca65` | ca65 V2.18 - N/A | 3 | 582 |
| `lwasm` | lwasm from lwtools 4.25 | 1 | 208 |
...
| `vasmm68k_mot` | vasm 2.0b (c) in 2002-2025 Volker Barthelmann | 1 | 392 |
<!-- /generated -->
