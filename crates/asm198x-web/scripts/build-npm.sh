...
#
# Architecture features let lesson pages download only the assembler they use.
# The linker drops unreferenced entry points; README.md records the measured
# saving and links the browser packaging decision.
#
