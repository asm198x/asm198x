...
const PROBES: &[Probe] = &[
    ...
    gap("acme", "operator &",            " lda #7&3\n",   20),
    gap("acme", "operator |",            " lda #1|2\n",   20),
    gap("acme", "operator ^",            " lda #5^1\n",   20),
    gap("acme", "operator <<",           " lda #1<<3\n",  20),
    gap("acme", "operator >>",           " lda #16>>2\n", 20),
    ...
    gap("pasmo", "hex 0x prefix",        " ld a,0x10\n",   21),
    gap("pasmo", "hex h suffix",         " ld a,10h\n",    21),
    gap("pasmo", "binary b suffix",      " ld a,1010b\n",  21),
    gap("pasmo", "octal o suffix",       " ld a,17o\n",    21),
    gap("pasmo", "operator <<",          " ld a,1<<2\n",   20),
    gap("pasmo", "operator &",           " ld a,5 & 3\n",  20),
    gap("pasmo", "operator |",           " ld a,4 | 1\n",  20),

    // ---- sjasmplus / z80 ----------------------------------------------------
    ok ("sjasmplus", "hex $ / 0x / h",   " ld a,$10\n ld b,0x10\n ld c,10h\n"),
    ok ("sjasmplus", "binary 0b / %",    " ld a,0b1010\n ld b,%1010\n"),
    ok ("sjasmplus", "db / dw / defb",   " db 1,2,3\n dw $1234\n defb 4\n"),
    gap("sjasmplus", "hex # prefix",     " ld a,#10\n",    21),
    ...
    gap("lwasm", "instruction andcc",    " andcc #$fe\n",   23),
    gap("lwasm", "instruction orcc",     " orcc #1\n",      23),
    gap("lwasm", "instruction cmpu",     " cmpu #$1234\n",  23),
    gap("lwasm", "instruction swi2",     " swi2\n",         23),
    ...
    gap("vasm", "new-style (d,An)",      " lea (4,a0),a1\n",       22),
    gap("vasm", "new-style (d,An,Xn)",   " lea (4,a0,d0.w),a1\n",  22),
    gap("vasm", "move (d,An)",           " move.w (4,a0),d0\n",    22),
    gap("vasm", "mnemonic suba",         " suba.l a0,a1\n",  25),
    gap("vasm", "mnemonic cmpa",         " cmpa.l a0,a1\n",  25),
    gap("vasm", "mnemonic adda",         " adda.l a0,a1\n",  16),
    ...
    gap("ca65-816", "operator &",        " lda #7&3\n",  20),
    gap("ca65-816", "operator |",        " lda #1|2\n",  18),
    gap("ca65-816", "operator <<",       " lda #1<<3\n", 20),
    gap("ca65-816", "instruction rtl",   " rtl\n",       24),
