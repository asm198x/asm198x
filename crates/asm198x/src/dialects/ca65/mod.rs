...
mod link;
mod project;
pub(crate) use link::VisRule;
use link::{Emit, Resolved, area_usage, emit, link, resolve};
use project::{Sweep, collect_syms, map_kind_syms, parsed_from_program};
