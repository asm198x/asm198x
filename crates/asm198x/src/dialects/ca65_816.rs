...
pub(crate) fn parse_program(source: &str, mode: macros::Expand) -> Result<Program, AsmError> {
    ...
    let expanded = ca65_flat::expand_ca65(source, mode, ca65_flat::Target::Wdc65816)?;
...
impl FlatWalk for Walker {
    ...
    fn expand_source(&self, source: &str) -> Result<macros::Expansion, AsmError> {
        ca65_flat::expand_ca65(source, macros::Expand::Yes, ca65_flat::Target::Wdc65816)
    }
...
pub const DIRECTIVES: &[Directive] = &[
    Directive {
        ...
        pattern: Pattern::Sigilled {
            sigil: '.',
            names: &[
                "setcpu", "segment", "smart", "p816", "i16", "a16", "i8", "a8",
            ],
            required: true,
        },
